<?php 
    ...
    require_once '../../views/users/register.php';
            ...
            $nationalites = [
                "Afghan", "Albanais", "Algérien", "Américain", "Andorran", "Angolais", "Antiguais", "Argentin", "Arménien", "Australien",
                "Autrichien", "Azerbaïdjanais", "Bahamien", "Bahreïnien", "Bangladais", "Barbadien", "Biélorusse", "Belge", "Bélizien",
                "Béninois", "Bhoutanais", "Bolivien", "Bosnien", "Brésilien", "Britannique", "Brunéien", "Bulgare", "Burkinabé", "Birman",
                "Burundais", "Cambodgien", "Camerounais", "Canadien", "Cap-verdien", "Centrafricain", "Tchadien", "Chilien", "Chinois",
                "Colombien", "Comorien", "Congolais", "Costaricain", "Croate", "Cubain", "Chypriote", "Tchèque", "Danois", "Djiboutien",
                "Dominicain", "Néerlandais", "Est-timorais", "Équatorien", "Égyptien", "Émirien", "Équato-guinéen", "Érythréen", "Estonien",
                "Éthiopien", "Fidjien", "Philippin", "Finlandais", "Français", "Gabonais", "Gambien", "Géorgien", "Allemand", "Ghanéen", "Grec",
                "Grenadien", "Guatémaltèque", "Guinéen", "Guyanais", "Haïtien", "Hondurien", "Hongrois", "Islandais", "Indien", "Indonésien",
                "Iranien", "Irakien", "Irlandais", "Israélien", "Italien", "Ivoirien", "Jamaïcain", "Japonais", "Jordanien", "Kazakhstani", "Kenyan",
                "Kiribatien", "Coréen", "Koweïtien", "Kirghize", "Laotien", "Letton", "Libanais", "Libérien", "Libyen", "Liechtensteinois",
                "Lituanien", "Luxembourgeois", "Macédonien", "Malgache", "Malawien", "Malaisien", "Maldivien", "Malien", "Maltais",
                "Marshallais", "Mauritanien", "Mauricien", "Mexicain", "Micronésien", "Moldave", "Monégasque", "Mongol", "Monténégrin",
                "Marocain", "Mozambicain", "Namibien", "Nauruan", "Népalais", "Néo-zélandais", "Nicaraguayen", "Nigérian", "Nigérien",
                "Néo-Calédonien", "Nord-coréen", "Norvégien", "Omani", "Pakistanais", "Palaosien", "Palestinien", "Panaméen", "Papouan-néo-guinéen",
                "Paraguayen", "Péruvien", "Polonais", "Portugais", "Qatari", "Roumain", "Russe", "Rwandais", "Saint-lucien", "Salvadorien",
                "Samoan", "Saint-marinais", "Santoméen", "Saoudien", "Sénégalais", "Serbe", "Seychellois", "Sierra-léonais", "Singapourien",
                "Slovaque", "Slovène", "Salomonais", "Somalien", "Sud-africain", "Sud-coréen", "Sud-soudanais", "Espagnol", "Sri-lankais", "Soudanais",
                "Surinamais", "Swazi", "Suédois", "Suisse", "Syrien", "Tadjik", "Tanzanien", "Thaïlandais", "Togolais", "Tongan", "Trinidadien/tobagonien",
                "Tunisien", "Turc", "Turkmène", "Tuvaluan", "Ougandais", "Ukrainien", "Uruguayen", "Ouzbek", "Vénézuélien", "Vietnamien", "Yéménite",
                "Zambien", "Zimbabwéen"
            ];